...
{
    std::cout << "COPYING content of ChatBot instance " << &source << " to ChatBot instance " << this << std::endl;
...
{
    std::cout << "ASSIGNING content of ChatBot instance " << &source << " to ChatBot instance " << this << std::endl;
...
{
    std::cout << "MOVING (c’tor) ChatBot instance " << &source << " to ChatBot instance " << this << std::endl;
