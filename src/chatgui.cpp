    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>(); // Constructs an object of type <ChatLogic> and wraps it in a std::unique_ptr. 
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // _chatLogic is deleted when it gets out of scope, no need to delete explicity
